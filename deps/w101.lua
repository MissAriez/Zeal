...
local World = class {
    ...
    progress = function(self, quest_number)
        ...
        return math.round(tonumber(tostring((quest_number / self.quest_count.total) * 100)), 2)
    end;
}
...
local w101 = {
    worlds = {
        ...
        grizzleheim = World('Grizzleheim', 68, 'side world', 'gh', AreaList(Area()));
        wintertusk = World('Wintertusk', 51, 'side world', 'wt', AreaList(Area()));
    };
    schools = {
